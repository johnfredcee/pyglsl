...
def make_spline(p0, p1, p2, p3, roll0, roll1, width, segments):
    ...
    for i in range(0, segments):
        ...
        pos = at0 + leftOffset
        # color = trackColor;
        # tCoords = euclid.Vector2(0.0, 0.0)
        ...
        pos = at0 + rightOffset
        # color = trackColor;
        # tCoords = euclid.Vector2(0.0, 1.0)
        verts.append(pos)
        ...
        pos = at1 + rightOffset
        # color = trackColor;
        # tCoords = euclid.Vector2(1.0, 1.0);
        verts.append(pos)
        ...
        pos = at1 + leftOffset
        # color = trackColor;
        # tCoords = euclid.Vector2(1.0, 0.0);
        verts.append(pos)
...
def make_track():
    track_points = [ { "z":-80.0, "y":-0.5, "x":20.0},
                     { "z":-50.0, "y":-0.5, "x":0.0},
                     { "z":50.0, "y":-0.5, "x":0.0},
                     { "z":80.0, "y":-0.5, "x":20.0},
                     { "z":80.0, "y":-0.5, "x":40.0, "roll":20},
                     { "z":50.0, "y":-0.5, "x":60.0},
                     { "z":-50.0, "y":-0.5, "x":60.0, "roll":20},
                     { "z":-80.0, "y":-0.5, "x":40.0} ]
    track_width = 20.0
    track_segments = []
    for i in range(1, len(track_points) + 1):
        ...
        track_segments.append(make_spline(make_vertex(track_points[i0]),
