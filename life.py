...
# create the texture
texture = pyglet.image.Texture.create(window.width, window.height, pyglet.gl.GL_RGBA)

# create a fullscreen quad
batch = pyglet.graphics.Batch()
batch.add(4, pyglet.gl.GL_QUADS, None, ('v2i', (0, 0, 1, 0, 1, 1, 0, 1)),
...
def copyFramebuffer(tex, *size):
    ...
    pyglet.gl.glCopyTexImage2D(pyglet.gl.GL_TEXTURE_2D, 0, pyglet.gl.GL_RGBA, 0, 0, tex.width, tex.height, 0);
    # unbind the texture
    pyglet.gl.glBindTexture(tex.target, 0)
